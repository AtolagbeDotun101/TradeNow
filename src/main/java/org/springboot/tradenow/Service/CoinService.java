...
import org.springboot.tradenow.Repository.CoinRepository;
import org.springboot.tradenow.Repository.Implementation.CoinImpl;
...
@Service
public class CoinService implements CoinImpl {
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try{
            ...
            coin.setPriceChange24h(marketData.get("price_change_24h").get("usd").asLong());
            coin.setPriceChangePercentage24h(marketData.get("price_change_percentage_24h").get("usd").asLong());
    ...
    @Override
    public String getTop50CoinByMarketChart() throws Exception {
